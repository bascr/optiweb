...
<!-- Inicio formulario -->
            {!! Form::open(['method'=>'POST', 'action'=>'PrescriptionController@createCrystalContact', 'onSubmit'=> 'return validaForm();' , 'class' => 'form-horizontal'])!!}
...
@section('script')
    ...
    {!! Html::script('custom/prescriptionfunctions_crystalcontact.js') !!}
@endsection
