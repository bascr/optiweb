...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading" style="color: #fff;background-color: #3C8DBC;">Ventas del mes</div>
        <div class="panel-body">
            ...
            <div class="col-md-12 modal-footer" style="margin-top: 20px;">
                <a href="{{ url('/report/month_sales/export') }}" class="btn btn-success"><i class="fa fa-file-excel-o"></i>  Exportar a excel</a>
